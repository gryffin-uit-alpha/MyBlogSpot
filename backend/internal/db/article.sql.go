...
const getRelatedArticles = `-- name: GetRelatedArticles :many
SELECT DISTINCT a.id, a.title, a.slug, a.summary, a.content, a.category_id, a.status, a.view_count, a.published_at, a.created_at, a.updated_at, a.search_vector
FROM articles a
...
type GetRelatedArticlesParams struct {
	ArticleID pgtype.UUID `json:"article_id"`
	Limit     int32       `json:"limit"`
}

func (q *Queries) GetRelatedArticles(ctx context.Context, arg GetRelatedArticlesParams) ([]Article, error) {
	rows, err := q.db.Query(ctx, getRelatedArticles, arg.ArticleID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
